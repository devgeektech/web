...
function setlr_credits() {
	?>
	<p class="site-credits"><?php printf( __( '&copy; %s %s - All Rights Reserved. Made with <i class="fa fa-heart"></i> in London.', 'setlr' ), date( 'Y', time() ), get_bloginfo( 'sitename' ) . ' Ltd' ); ?></p>
    <?php
}
...
/* Remove the login page shake if error */
...
/* Change the error message so hackers do not see account details entered incorrectly */

function login_error_override()
{
    return 'Oops. Better try that again.';
}
