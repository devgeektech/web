...
class KS_Giveaways_Admin
{
    ...
    public function admin_init()
    {
        ...
        if ($tab == 'general') {
            register_setting('ks_giveaways_options', KS_GIVEAWAYS_OPTION_DRAW_MODE, '');
        ...
        if ($tab == 'services') {
            ...
            register_setting('ks_giveaways_options', KS_GIVEAWAYS_OPTION_SYNC_WHEN, '');
            ...
            if (KS_Giveaways_CampaignMonitor::is_valid()) {
                ...
                register_setting('ks_giveaways_options', KS_GIVEAWAYS_OPTION_CAMPAIGNMONITOR_LIST_ID, '');
