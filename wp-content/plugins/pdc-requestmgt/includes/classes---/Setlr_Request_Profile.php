...
class Setlr_Request_Profile {
    ...
    public function get_content( $data ) {
        ...
        public function show_customer_profile() {
            ...
            $html .= '<input type="text" name="firstname" value=""></label></p>';
            $html .= '<p><label for="lastname">' . __( 'Lastname', 'pdcrequest' );
            $html .= '<input type="text" name="lastname" value=""></label></p>';
            ...
            $html .= '<input type="email" name="email" value=""></label></p>';
            $html .= '<p><label for="phone">' . __( 'Phone', 'pdcrequest' );
            $html .= '<input type="tel" name="phone" value=""></label></p>';
            $html .= '<p><label for="nickname">' . __( 'Nickname', 'pdcrequest');
            $html .= '<input type="text" name="nickname" value=""></label></p>';
            $html .= '</fieldset>';
            ...
            $html .= '<input type="text" name="billing_company" value=""></label></p>';
            

            $html .= '<p><label for="billing_address_1">' . __( 'Address', 'pdcrequest' );
            $html .= '<input type="text" name="billing_address_1" value=""></label></p>';
            $html .= '<p><label for="billing_addres_2">' . __( 'Address Complement', 'pdcrequest' );
            $html .= '<input type="text" name="billing_address_2" value=""></label></p>';
            $html .= '<p><label for="billing_postcode">' . __( 'Zipcode/Postcode', 'pdcrequest' );
            $html .= '<input type="text" name="billing_postcode" value=""></label></p>';
            $html .= '<p><label for="billing_city">' . __( 'City', 'pdcrequest' );
            $html .= '<input type="text" name="billing_city" value=""></label></p>';
