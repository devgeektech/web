...
Tags: smtp, email, mail, mailer, email log, oauth 2.0, gmail, google apps, hotmail, yahoo, mandrill api, sendgrid api
...
* Gmail: By combining OAuth 2.0 and the Gmail API, Postman can deliver where other plugins can not
...
* SendGrid API for sending any email (requires a [SendGrid](https://sendgrid.com) account)
...
* Memory: 1.5MiB per request at idle
...
> Postman is developed on OS X with PHP 5.3/5.5. Postman is tested on [Red Hat OpenShift](http://www.openshift.com/)/GoDaddy (PHP 5.4) with Gmail, Hotmail, Yahoo Mail (US) and [mailtrap.io](http://mailtrap.io).
...
= 2.0.0 - 2015-12-01 =
* Fixed sending of attachments in Mandrill

= 1.7.3 - 2015-11-14 =
* [[Ticket](https://wordpress.org/support/topic/undefined-offset-error-2?replies=6)] Fix for undefined offset error when run with PHP v5.0
* Multisite support is turned on
