...
(function($) {
  vimeoGAJS = {
    ...
    sendEvent: function (iframeEl, action) {
      ...
      case 'gtm':
dataLayer.push({'event': 'Vimeo', 'eventCategory': 'Vimeo', 'eventAction': 'Started video', 'eventLabel': 'https://player.vimeo.com/video/143247106', 'eventValue': undefined, 'eventNonInteraction': true});
dataLayer.push({'event': 'Vimeo', 'eventCategory': 'Vimeo', 'eventAction': 'Paused video', 'eventLabel': 'https://player.vimeo.com/video/143247106', 'eventValue': undefined, 'eventNonInteraction': true});
dataLayer.push({'event': 'Vimeo', 'eventCategory': 'Vimeo', 'eventAction': 'Resumed video', 'eventLabel': 'https://player.vimeo.com/video/143247106', 'eventValue': undefined, 'eventNonInteraction': true});
dataLayer.push({'event': 'Vimeo', 'eventCategory': 'Vimeo', 'eventAction': 'Completed video', 'eventLabel': 'https://player.vimeo.com/video/143247106', 'eventValue': undefined, 'eventNonInteraction': true});
dataLayer.push({'event': 'Vimeo', 'eventCategory': 'Vimeo', 'eventAction': 'Skipped video forward or backward', 'eventLabel': 'https://player.vimeo.com/video/143247106', 'eventValue': undefined, 'eventNonInteraction': true});
        break;

      case 'ua':
   
	  ga('send', 'event', 'Vimeo', 'Started video', 'https://player.vimeo.com/video/143247106', undefined,{'nonInteraction': true});
ga('send', 'event', 'Vimeo', 'Paused video', 'https://player.vimeo.com/video/143247106', undefined, {'nonInteraction': true});
ga('send', 'event', 'Vimeo', 'Resumed video', 'https://player.vimeo.com/video/143247106', undefined, {'nonInteraction': true});
ga('send', 'event', 'Vimeo', 'Completed video', 'https://player.vimeo.com/video/143247106', undefined, {'nonInteraction': true});
ga('send', 'event', 'Vimeo', 'Skipped video forward or backward', 'https://player.vimeo.com/video/143247106', undefined, {'nonInteraction':true});       
        break;

      case 'ga':
_gaq.push(['_trackEvent', 'Vimeo', 'Started video', 'https://player.vimeo.com/video/143247106', undefined, true]);
_gaq.push(['_trackEvent', 'Vimeo', 'Paused video', 'https://player.vimeo.com/video/143247106', undefined, true]);
_gaq.push(['_trackEvent', 'Vimeo', 'Resumed video', 'https://player.vimeo.com/video/143247106', undefined, true]);
_gaq.push(['_trackEvent', 'Vimeo', 'Completed video', 'https://player.vimeo.com/video/143247106', undefined, true]);
_gaq.push(['_trackEvent', 'Vimeo', 'Skipped video forward or backward', 'https://player.vimeo.com/video/143247106', undefined, true]]);
        break;
      }
    }
  };
